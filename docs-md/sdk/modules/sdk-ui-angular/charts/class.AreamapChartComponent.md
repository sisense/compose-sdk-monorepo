...
> **dataPointClick**: `EventEmitter`\< `ArgumentsAsObject`\< [`AreamapDataPointEventHandler`](../../sdk-ui/type-aliases/type-alias.AreamapDataPointEventHandler.md) \| `undefined`, [`"point"`, `"nativeEvent"`] \> \>
