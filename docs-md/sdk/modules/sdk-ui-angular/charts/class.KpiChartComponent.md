...
> **new KpiChartComponent**(): [`KpiChartComponent`](class.KpiChartComponent.md)
...
> **dataOptions**: [`KpiChartDataOptions`](../interfaces/interface.KpiChartDataOptions.md)
...
> **styleOptions**: [`KpiStyleOptions`](../interfaces/interface.KpiStyleOptions.md) \| `undefined`
...
> **beforeRender**: [`KpiBeforeRenderHandler`](../type-aliases/type-alias.KpiBeforeRenderHandler.md) \| `undefined`
...
> **dataPointClick**: `EventEmitter`\< [`KpiDataPointEvent`](../type-aliases/type-alias.KpiDataPointEvent.md) \>
...
> **dataPointContextMenu**: `EventEmitter`\< [`KpiDataPointEvent`](../type-aliases/type-alias.KpiDataPointEvent.md) \>
...
render-level [`onBeforeRender`](../../sdk-ui/interfaces/interface.KpiChartEventProps.md#onbeforerender).
