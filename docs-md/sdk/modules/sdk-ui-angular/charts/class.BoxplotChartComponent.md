...
> **dataPointClick**: `EventEmitter`\< `ArgumentsAsObject`\< [`BoxplotDataPointEventHandler`](../../sdk-ui/type-aliases/type-alias.BoxplotDataPointEventHandler.md) \| `undefined`, [`"point"`, `"nativeEvent"`] \> \>
...
> **dataPointContextMenu**: `EventEmitter`\< `ArgumentsAsObject`\< [`BoxplotDataPointEventHandler`](../../sdk-ui/type-aliases/type-alias.BoxplotDataPointEventHandler.md) \| `undefined`, [`"point"`, `"nativeEvent"`] \> \>
