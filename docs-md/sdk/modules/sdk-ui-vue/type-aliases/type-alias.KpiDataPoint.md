...
Like [IndicatorDataPoint](../../sdk-ui/type-aliases/type-alias.IndicatorDataPoint.md), the whole card is one data point, so every zone is exposed
...
> #### `entries.comparison`
>
> **comparison**?: [`DataPointEntry`](../../sdk-ui/type-aliases/type-alias.DataPointEntry.md)
>
