...
Props of the [BarChart](../classes/class.BarChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.BarChartProps-2.md#dataoptions), [filters](interface.BarChartProps-2.md#filters), and [highlights](interface.BarChartProps-2.md#highlights).
