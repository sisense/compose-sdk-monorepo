...
Props of the [AreamapChart](../classes/class.AreamapChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.AreamapChartProps-2.md#dataoptions), [filters](interface.AreamapChartProps-2.md#filters), and [highlights](interface.AreamapChartProps-2.md#highlights).
