...
Props of the [PolarChart](../classes/class.PolarChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.PolarChartProps-2.md#dataoptions), [filters](interface.PolarChartProps-2.md#filters), and [highlights](interface.PolarChartProps-2.md#highlights).
