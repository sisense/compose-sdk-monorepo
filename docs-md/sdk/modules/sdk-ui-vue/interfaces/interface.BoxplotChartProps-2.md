...
Props of the [BoxplotChart](../classes/class.BoxplotChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.BoxplotChartProps-2.md#dataoptions), [filters](interface.BoxplotChartProps-2.md#filters), and [highlights](interface.BoxplotChartProps-2.md#highlights).
