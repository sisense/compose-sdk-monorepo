...
Props of the [SunburstChart](../classes/class.SunburstChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.SunburstChartProps-2.md#dataoptions), [filters](interface.SunburstChartProps-2.md#filters), and [highlights](interface.SunburstChartProps-2.md#highlights).
