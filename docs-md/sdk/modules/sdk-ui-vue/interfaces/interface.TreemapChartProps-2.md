...
Props of the [TreemapChart](../classes/class.TreemapChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.TreemapChartProps-2.md#dataoptions), [filters](interface.TreemapChartProps-2.md#filters), and [highlights](interface.TreemapChartProps-2.md#highlights).
