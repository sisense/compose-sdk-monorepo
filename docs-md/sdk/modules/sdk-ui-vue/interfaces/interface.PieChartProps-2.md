...
Props of the [PieChart](../classes/class.PieChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.PieChartProps-2.md#dataoptions), [filters](interface.PieChartProps-2.md#filters), and [highlights](interface.PieChartProps-2.md#highlights).
