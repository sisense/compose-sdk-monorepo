...
Props of the [AreaChart](../classes/class.AreaChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.AreaChartProps-2.md#dataoptions), [filters](interface.AreaChartProps-2.md#filters), and [highlights](interface.AreaChartProps-2.md#highlights).
