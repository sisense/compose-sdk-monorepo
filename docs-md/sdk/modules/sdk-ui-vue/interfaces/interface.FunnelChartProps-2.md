...
Props of the [FunnelChart](../classes/class.FunnelChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.FunnelChartProps-2.md#dataoptions), [filters](interface.FunnelChartProps-2.md#filters), and [highlights](interface.FunnelChartProps-2.md#highlights).
