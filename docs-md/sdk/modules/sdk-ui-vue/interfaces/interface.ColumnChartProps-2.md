...
Props of the [ColumnChart](../classes/class.ColumnChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.ColumnChartProps-2.md#dataoptions), [filters](interface.ColumnChartProps-2.md#filters), and [highlights](interface.ColumnChartProps-2.md#highlights).
