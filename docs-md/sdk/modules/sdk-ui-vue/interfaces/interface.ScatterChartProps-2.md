...
Props of the [ScatterChart](../classes/class.ScatterChart-2.md) component.
...
and load the data as specified in [dataOptions](interface.ScatterChartProps-2.md#dataoptions), [filters](interface.ScatterChartProps-2.md#filters), and [highlights](interface.ScatterChartProps-2.md#highlights).
