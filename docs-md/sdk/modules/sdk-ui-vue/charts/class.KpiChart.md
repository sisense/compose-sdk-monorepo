...
> **`readonly`** **dataOptions**: [`KpiChartDataOptions`](../interfaces/interface.KpiChartDataOptions.md)
...
> **`readonly`** **styleOptions**?: [`KpiStyleOptions`](../interfaces/interface.KpiStyleOptions.md)
...
> **`readonly`** **onBeforeRender**?: [`KpiBeforeRenderHandler`](../type-aliases/type-alias.KpiBeforeRenderHandler.md)
...
> **`readonly`** **onDataPointClick**?: [`KpiDataPointEventHandler`](../type-aliases/type-alias.KpiDataPointEventHandler.md)
...
> **`readonly`** **onDataPointContextMenu**?: [`KpiDataPointEventHandler`](../type-aliases/type-alias.KpiDataPointEventHandler.md)
