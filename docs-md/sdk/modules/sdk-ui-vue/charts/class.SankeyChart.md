...
> **`readonly`** **dataOptions**: [`SankeyChartDataOptions`](../interfaces/interface.SankeyChartDataOptions.md)
...
> **`readonly`** **styleOptions**?: [`SankeyStyleOptions`](../interfaces/interface.SankeyStyleOptions.md)
