...
test.describe('indicator', () => {
    ...
    test('verify simple vertical numeric indicator with formatting', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--simple-vertical-numeric-indicator-with-custom-number-formatting`);
        await makeScreenshotsOverPage(page);
    });
    ...
    test('verify numeric indicator with string color options', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--numeric-indicator-with-string-color-options`);
        await makeScreenshotsOverPage(page);
    });

    test('verify numeric indicator with uniform color options', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--numeric-indicator-with-uniform-color-options`);
        await makeScreenshotsOverPage(page);
    });

    test('verify numeric indicator with conditional color options', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--numeric-indicator-with-conditional-color-options`);
        await makeScreenshotsOverPage(page);
    });
    ...
    test.skip('verify ticker numeric indicator with secondary value', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--ticker-numeric-indicator-with-secondary-value`);
        await makeScreenshotsOverPage(page);
    });
    ...
    test('verify ticker gauge indicator with forced ticker', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--ticker-gauge-indicator-with-forced-ticker`);
        await makeScreenshotsOverPage(page);
    });

    test('verify numeric indicator with N/A value', async ({ page }) => {
        await page.goto(`${url}/iframe.html?id=charts-indicator--numeric-indicator-with-not-available-value`);
        await makeScreenshotsOverPage(page);
    });
});
