...
import styles from './YAxisSection.module.scss';
          ...
          <tbody>
              ...
              >
                <td className={styles.checkBoxTD}>
                  <div className={styles.center}>
                    <Checkbox checked={!!yAxis?.gridLines} readOnly />
                  </div>
                </td>
                <td>
            ...
            {showLogarithmic && (
              ...
              >
                <td className={styles.checkBoxTD}>
                  <div className={styles.center}>
                    <Checkbox checked={yAxis.logarithmic} readOnly />
                  </div>
                </td>
                <td>
            ...
            <tr
              onClick={() =>
                onClick({
                  ...yAxis,
                  labels: { ...yAxis.labels, enabled: !yAxis.labels?.enabled },
                })
              }
            >
              <td className={styles.checkBoxTD}>
                <div className={styles.center}>
                  <Checkbox checked={!!yAxis.labels?.enabled} readOnly />
                </div>
              </td>
              <td>
            ...
            <tr>
              ...
              >
                <div className={styles.center}>
                  <Checkbox checked={!!yAxis?.title?.enabled} readOnly />
                </div>
              </td>
              <td>
