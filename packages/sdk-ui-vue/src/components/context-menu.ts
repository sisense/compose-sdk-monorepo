...
import { ContextMenu as ContextMenuPreact } from '@ethings-os/sdk-ui-preact';
import type { ContextMenuProps as ContextMenuPropsPreact } from '@ethings-os/sdk-ui-preact';
import { setupHelperWithChildren } from '../helpers/setup-helper';

/**
 * Props of the {@link @ethings-os/sdk-ui-vue!ContextMenu | `ContextMenu`} component.
 */
