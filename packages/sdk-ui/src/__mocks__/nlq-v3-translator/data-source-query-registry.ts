...
import {
  ...
  SAMPLE_ECOMMERCE_QUERY_WITH_CALCULATED_DIMENSION,
  SAMPLE_ECOMMERCE_QUERY_WITH_NESTED_FILTER_RELATIONS,
  SAMPLE_ECOMMERCE_QUERY_WITH_STYLED_CALCULATED_DIMENSION,
...
export const DATA_SOURCE_QUERY_REGISTRY: Record<string, Record<string, QueryInput>> = {
  'Sample ECommerce': {
    ...
    'Calculated Dimension': {
      data: SAMPLE_ECOMMERCE_QUERY_WITH_CALCULATED_DIMENSION,
      context: {
        dataSource: SAMPLE_ECOMMERCE_DATA_SOURCE,
        tables: SAMPLE_ECOMMERCE_TABLES,
      },
    },
    'Calculated Dimension - Styled Column': {
      data: SAMPLE_ECOMMERCE_QUERY_WITH_STYLED_CALCULATED_DIMENSION,
      context: {
        dataSource: SAMPLE_ECOMMERCE_DATA_SOURCE,
        tables: SAMPLE_ECOMMERCE_TABLES,
      },
