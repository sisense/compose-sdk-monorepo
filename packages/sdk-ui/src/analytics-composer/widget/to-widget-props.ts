...
export const toWidgetPropsFromQuery = (
  ...
  try {
    ...
    // ranking filter jaql generated by NLQ may be problematic, so we need to fix it
    const fixedMetadata = fixRankingFilterJaql(metadata);

    const simplifiedMetadata = fixedMetadata
