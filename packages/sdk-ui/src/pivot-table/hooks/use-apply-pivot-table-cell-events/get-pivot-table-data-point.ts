...
export const getPivotTableDataPoint = (
  ...
  if (isDataValueCell) {
    ...
    rowsEntries = availableRowsDataOptions?.map((item, index) => {
      ...
      return {
        ...getDataPointMetadata(`rows.${index}`, item),
        value,
        displayValue,
      } as DataPointEntry;
    });
    ...
    columnsEntries = availableColumnDataOptions?.map((item, index) => {
      ...
      return {
        ...getDataPointMetadata(`columns.${index}`, item),
        value,
        displayValue,
      } as DataPointEntry;
    });
    ...
    valuesEntries = [
      {
        ...getDataPointMetadata(`values.${valueIndex}`, valueDataOption!),
  ...
  if (isCaptionRowCell && !isGrandTotalRowCell) {
    ...
    rowsEntries = [
      {
        ...getDataPointMetadata(`rows.${dataOptionIndex}`, rowDataOption!),
  ...
  if (isCaptionColumnCell && !isGrandTotalColumnCell) {
    ...
    columnsEntries = [
      {
        ...getDataPointMetadata(`columns.${dataOptionIndex}`, columnDataOption!),
  ...
  if (isCaptionValueCell) {
    ...
    valuesEntries = [
      {
        ...getDataPointMetadata(`values.${index}`, valueDataOption!),
        value: columnDataNode.value,
        displayValue: columnDataNode.content,
      } as DataPointEntry,
    ];
