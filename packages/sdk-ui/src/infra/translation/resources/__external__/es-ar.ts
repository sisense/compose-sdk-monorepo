...
const translation: TranslationDictionary = {
  ...
  filterWidget: {
    ...
    controls: {
      ...
      fillOrRemoveCondition: 'Completá o quitá la condición',
  ...
  narrativeWidget: {
    ...
    copied: 'Copiado',
    creditsUsed: 'Se usó el {{usagePercentage}}% de los créditos de IA.',
    noDataTitle: 'No hay datos del panel disponibles',
    noDataDescription:
      'Cuando los datos del panel estén disponibles, podrás generar una narrativa.',
    failedTitle: 'No se pudo generar la narrativa',
    failedDescription:
      'Volvé a intentarlo más tarde. Si el problema persiste, comunicate con tu administrador.',
  },
  ai: {
    ...
    quota: {
      ...
      exceededErrorDescription:
        'Alcanzaste la cuota mensual de IA de tu empresa. La cuota se renovará automáticamente en tu próximo ciclo de uso mensual.',
      warningDescription: 'Usaste el {{usagePercentage}}% de la cuota mensual de IA de tu empresa.',
    },
  },
  attribute: {
    datetimeName: {
  ...
  filterEditor: {
    ...
    tooltips: {
      selectAllPartiallyLoaded:
        'No se muestran todos los valores. Desplácese hacia abajo en la lista para cargar los valores restantes. También puede usar la condición "No es" a continuación para excluir valores específicos.',
    },
    labels: {
