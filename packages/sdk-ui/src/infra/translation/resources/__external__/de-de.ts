...
const translation: TranslationDictionary = {
  ...
  widgetHeader: {
    ...
    menu: {
      ...
      repeatRowsRecommended: 'Zeilen wiederholen (Empfohlen)',
      mergeRows: 'Zeilen zusammenführen',
    },
  },
  customWidgets: {
    registerPrompt:
  ...
  filterTile: {
    ...
    toggleSwitch: 'Filter aktivieren/deaktivieren',
    linkedToWidget: {
  ...
  kpi: {
    comparison: {
      ...
      vsPriorQuarter: 'ggü. Vorquartal',
      vsPriorMonth: 'ggü. Vormonat',
      vsPriorWeek: 'ggü. Vorwoche',
      vsPriorDay: 'ggü. Vortag',
      vsPriorPeriod: 'ggü. Vorperiode',
    },
    target: {
      ofGoal: '{{percent}} des Ziels',
      toGo: 'noch {{value}}',
    },
  ...
  queryDefinition: {
    showMorePills: '{{count}} weitere anzeigen',
