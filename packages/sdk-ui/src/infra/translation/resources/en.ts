export const translation = {
  errors: {
    ...
    chartNoSisenseContext:
      'Sisense context for Chart not found. To fix, wrap the component with a Sisense context provider, or provide an existing dataSet via props.',
    widgetByIdNoSisenseContext:
      'Sisense context for Dashboard Widget not found. To fix, wrap the component with a Sisense context provider.',
    widgetByIdInvalidIdentifier:
      'Failed to retrieve widget {{widgetOid}} from dashboard {{dashboardOid}}. ' +
      'Please make sure the dashboard widget exists and is accessible.',
    dashboardWidgetsInvalidIdentifiers:
      'Failed to retrieve dashboard widgets from dashboard {{dashboardOid}}. ' +
      'Please make sure the dashboard exists and is accessible.',
    executeQueryNoSisenseContext:
      'Sisense context for query execution not found. To fix, wrap the component with a Sisense context provider.',
    ...
    themeNotFound: 'Theme with oid {{themeOid}} not found in the connected Sisense environment',
    paletteNotFound: "Palette '{{paletteName}}' not found in the connected Sisense environment",
    chartTypeNotSupported: 'Chart type {{chartType}} is not supported',
    chartInvalidProps: 'Invalid chart props for chart type: {{chartType}}',
    unsupportedWidgetType: 'Cannot extract props for unsupported widget type - {{widgetType}}',
    dashboardInvalidIdentifier:
      'Failed to retrieve dashboard {{dashboardOid}}. Please ensure the dashboard exists, and is accessible to the current user.',
    sharedFormula: {
      identifierExpected:
        'Failed to retrieve shared formula. Please provide oid or both name and datasource. ' +
        'Provided values: name={{name}}, dataSource={{dataSource}}, oid={{oid}}',
      failedToFetchByOid: 'Failed to fetch shared formula by oid {{oid}}',
      failedToFetchByName:
        'Failed to fetch shared formula by name {{name}} and dataSource {{dataSource}}',
    },
    widgetModel: {
      incompleteWidget:
        'WidgetModelTranslator: Widget can not be transformed to DTO because of incomplete property ({{prop}})',
      unsupportedWidgetTypeDto:
        'WidgetModelTranslator: Saving the widget of type {{chartType}} is not supported',
      pivotWidgetNotSupported:
        'WidgetModelTranslator: Pivot widget is not supported for method {{methodName}}',
      textWidgetNotSupported:
        'WidgetModelTranslator: Text widget is not supported for method {{methodName}}',
      onlyTableWidgetSupported:
        'WidgetModelTranslator: Only table widget is supported for method {{methodName}}',
      onlyPivotWidgetSupported:
        'WidgetModelTranslator: Only pivot widget is supported for method {{methodName}}',
      onlyTextWidgetSupported:
        'WidgetModelTranslator: Only text widget is supported for method {{methodName}}',
      onlyCustomWidgetSupported:
        'WidgetModelTranslator: Only custom widget is supported for method {{methodName}}',
    ...
    unknownFilterInFilterRelations:
      'Filter relationship contains a filter {{filterGuid}} which could not be found in the provided filters',
    invalidFilterType: 'Invalid filter type. Expected: {{filterType}}',
    secondsDateTimeLevelIsNotSupported:
      "Datetime level 'seconds' is not supported for this datasource",
    ...
    requiredColumnMissing: 'A required column is missing. {{hint}}',
    unexpectedChartType: 'Unexpected chart type: {{chartType}}',
    noRowNumColumn: 'Data has no row num column: {{columnName}}',
    tickIntervalCalculationFailed:
      'Unable to calculate tick interval. Try specifying datetime granularity.',
    ...
    indicatorInvalidRelativeSize: 'Invalid relative size options for indicator chart',
  ...
  dateFilter: {
    ...
    todayOutOfRange: 'Today is outside of the available date range',
    dateRange: {
      fromTo: '{{from}} to {{to}}',
      from: 'From {{val}}',
      to: 'To {{val}}',
