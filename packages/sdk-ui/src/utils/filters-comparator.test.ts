...
describe('isFiltersChanged', () => {
  const someFilter = filters.greaterThan(DM.Commerce.Revenue, 1000);
  const someAnotherFilter = filters.lessThan(DM.Commerce.Revenue, 1000);
  const someAnotherFilterUpdated = filters.lessThan(DM.Commerce.Revenue, 100);
