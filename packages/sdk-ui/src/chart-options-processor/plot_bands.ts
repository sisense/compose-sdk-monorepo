...
import { PlotBand, getCategoricalCompareValue } from './translations/axis_section';
import { StackableChartDesignOptions } from './translations/design_options';
import { defaultConfig, applyFormatPlainText } from './translations/number_format_config';
