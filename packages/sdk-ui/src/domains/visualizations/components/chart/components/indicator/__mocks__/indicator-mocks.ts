...
import { IndicatorLegacyChartOptions } from '@/domains/visualizations/components/chart/components/indicator-canvas';
import { IndicatorChartData } from '@/domains/visualizations/core/chart-data/types.js';
import { IndicatorChartDesignOptions } from '@/domains/visualizations/core/chart-options-processor/translations/design-options.js';
