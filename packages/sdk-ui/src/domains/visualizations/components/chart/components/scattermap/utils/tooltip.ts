...
import { ScattermapChartLocation } from '@/domains/visualizations/core/chart-data/types';
import { formatTooltipValue } from '@/domains/visualizations/core/chart-options-processor/translations/tooltip-utils.js';
...
// todo: reuse common loading indicator from `loading-overlay.tsx`
