...
import { Scattermap } from '@/domains/visualizations/components/chart/components/scattermap/scattermap';
import { ScattermapChartDataOptionsInternal } from '@/domains/visualizations/core/chart-data-options/types';
