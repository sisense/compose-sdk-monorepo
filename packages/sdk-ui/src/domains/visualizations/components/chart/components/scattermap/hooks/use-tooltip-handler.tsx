...
import { mergeFilters } from '@/domains/widgets/components/widget-by-id/utils.js';

import { useSisenseContext } from '../../../../../../../infra/contexts/sisense-context/sisense-context.js';
import {
  executeQuery,
  QueryDescription,
} from '../../../../../../query-execution/core/execute-query.js';
import { ScattermapChartDataOptionsInternal } from '../../../../../core/chart-data-options/types.js';
import {
  isMeasureColumn,
  translateColumnToAttribute,
} from '../../../../../core/chart-data-options/utils.js';
import { ScattermapChartLocation } from '../../../../../core/chart-data/types.js';
import { splitLocationName } from '../utils/location.js';
import { createScattermapTooltip, TooltipShowDetails } from '../utils/tooltip.js';
