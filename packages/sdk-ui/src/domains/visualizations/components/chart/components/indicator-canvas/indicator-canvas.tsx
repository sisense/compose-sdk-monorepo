...
import { IndicatorChartData } from '../../../../core/chart-data/types';
import { ChartData } from '../../../../core/chart-data/types';
import { getDataPointMetadata } from '../../../../core/chart-options-processor/data-points';
import {
  GaugeSpecificDesignOptions,
  IndicatorChartDesignOptions,
} from '../../../../core/chart-options-processor/translations/design-options';
import {
  applyFormatPlainText,
  getCompleteNumberFormatConfig,
} from '../../../../core/chart-options-processor/translations/number-format-config';
import { DesignOptions } from '../../../../core/chart-options-processor/translations/types';
import { ChartRendererProps } from '../../types';
import { Indicator } from '../indicator/chart/indicator';
import {
  createLegacyChartDataOptions,
  IndicatorLegacyChartDataOptions,
} from '../indicator/indicator-legacy-chart-data-options';
import { createIndicatorLegacyChartOptions } from '../indicator/indicator-legacy-chart-options';
import {
  applyIndicatorRenderOptions,
  buildRenderOptionsFromLegacyOptions,
  IndicatorRenderOptions,
} from '../indicator/indicator-render-options';
