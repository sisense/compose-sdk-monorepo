...
import { prepareTickerOptions } from '@/domains/visualizations/components/chart/components/indicator/indicator-legacy-chart-options/prepare-ticker-options.js';
