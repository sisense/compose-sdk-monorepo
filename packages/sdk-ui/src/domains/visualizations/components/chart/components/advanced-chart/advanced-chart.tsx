...
import ErrorBoundaryBox from '@/infra/error-boundary/error-boundary-box.js';
...
import '../../chart.css';
import { RegularChart } from '../regular-chart/regular-chart.js';
...
export const AdvancedChart = (props: RegularChartProps) => {
  ...
  if (!isDataSource(props.dataSet)) throw new TranslatableError('errors.missingDataSource');
