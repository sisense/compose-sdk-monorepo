...
import { withYAxisNormalizationForPolar } from '@/domains/visualizations/core/chart-options-processor/cartesian/utils/axis/axis-builders.js';
...
// Mock dependencies
vi.mock(
  '@/domains/visualizations/core/chart-options-processor/style-to-design-options-translator/translate-to-highcharts-options',
  () => ({
...
vi.mock(
  '@/domains/visualizations/core/chart-options-processor/style-to-design-options-translator/prepare-design-options',
  () => ({
...
vi.mock('@/domains/visualizations/core/chart-options-processor/chart-options-service', () => ({
  getDefaultStyleOptions: vi.fn(),
}));

vi.mock('@/domains/visualizations/core/chart-options-processor/subtype-to-design-options', () => ({
...
vi.mock(
  '@/domains/visualizations/core/chart-options-processor/cartesian/utils/axis/axis-builders',
  () => ({
