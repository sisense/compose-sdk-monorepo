...
vi.mock('@/domains/visualizations/core/chart-options-processor/translations/axis-section', () => ({
...
vi.mock('@/domains/visualizations/core/chart-data-options/utils', async () => {
  const actual = (await vi.importActual(
    '@/domains/visualizations/core/chart-data-options/utils',
  )) as any;
  return {
    ...actual,
...
vi.mock('@/shared/utils/create-level-attribute.js', async () => {
  const actual = (await vi.importActual('@/shared/utils/create-level-attribute.js')) as any;
  return {
    ...actual,
