...
import {
  createForecastDataOptions,
  isForecastChart,
} from '@/domains/visualizations/core/chart-data/advanced-analytics-data';
...
export type SeriesType = HighchartsSeriesValues & {
  /**
   * Name of the series that this series is related to.
   * Used for statistical model data (forecast, trend).
   *
   * @internal
   */
  statisticalSeriesRelatesToSeries?: string;
  index?: number;
  animation?: boolean;
