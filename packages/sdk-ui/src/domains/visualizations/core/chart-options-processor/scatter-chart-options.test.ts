...
import { getScatterChartOptions, getScatterLegendSettings } from './scatter-chart-options.js';
import { SERIES_CAPACITY } from './translations/base-design-options.js';
import { ScatterCustomPointOptions } from './translations/scatter-tooltip.js';
import { ChartDesignOptions } from './translations/types.js';
