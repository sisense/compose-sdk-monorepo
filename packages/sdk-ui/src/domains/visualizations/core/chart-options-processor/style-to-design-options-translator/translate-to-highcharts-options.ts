...
import { withYAxisNormalizationForPolar } from '../cartesian/utils/axis/axis-builders.js';
import { getDefaultStyleOptions } from '../chart-options-service.js';
import { chartSubtypeToDesignOptions } from '../subtype-to-design-options.js';
...
import {
  ...
  SERIES_CAPACITY,
} from '../translations/base-design-options.js';
import {
...
} from '../translations/design-options.js';
import {
  DefaultFunnelDirection,
  DefaultFunnelSeriesLabels,
  DefaultFunnelSize,
  DefaultFunnelType,
} from '../translations/funnel-plot-options.js';
import { Marker } from '../translations/marker-section.js';
import { PieType } from '../translations/pie-plot-options.js';
import {
  defaultScatterMarkerSize,
  ScatterMarkerSize,
} from '../translations/scatter-plot-options.js';
import { StackType } from '../translations/translations-to-highcharts.js';
import { CartesianChartType, SeriesDesignOptions } from '../translations/types.js';
import {
  extendStyleOptionsWithDefaults,
  getDesignOptionsPerSeries,
} from './prepare-design-options.js';
