...
import { formatDateValue } from '../../../query-execution/core/date-formats/apply-date-format';
import {
      ...
      expect(chartOptions.series[0].data).toEqual([
        {
          ...
          custom: {
            number1: 100,
            rawValue: 15654,
            xValue: ['Website visits'],
            xDisplayValue: ['Website visits'],
          },
        },
        {
          name: 'Downloads',
          ...
          color: '#9b9bd7',
          custom: {
            number1: 25.96141561262297,
            rawValue: 4064,
            xValue: ['Downloads'],
            xDisplayValue: ['Downloads'],
          },
        },
        {
          ...
          color: '#6eda55',
          custom: {
            number1: 12.693241344065415,
            rawValue: 1987,
            xValue: ['Requested price list'],
            xDisplayValue: ['Requested price list'],
          },
        },
        {
          name: 'Invoice sent',
          ...
          color: '#fc7570',
          custom: {
            number1: 6.234828158937013,
            rawValue: 976,
            xValue: ['Invoice sent'],
            xDisplayValue: ['Invoice sent'],
          },
        },
        {
          name: 'Finalized',
          ...
          color: '#fbb755',
          custom: {
            number1: 5.40436949022614,
            rawValue: 846,
            xValue: ['Finalized'],
            xDisplayValue: ['Finalized'],
          },
        },
      ]);
    });
