...
import {
  ...
  isTrendSeries,
  rangeTitle,
} from '@/domains/visualizations/core/chart-options-processor/advanced-chart-options';
...
import { rangeData } from './range-data.js';
import { CartesianChartData } from './types.js';
