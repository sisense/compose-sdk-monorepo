...
import { de, enGB, enUS, es, fr, it, ja, ko, nl, pt, ru, tr, uk, zhCN } from 'date-fns/locale';
...
/**
 * Maps language code (BCP 47 or short form) to date-fns Locale.
 * Supports the SDK translation locale code system: de-DE, en-US, es-AR, es-ES, etc.
 */
