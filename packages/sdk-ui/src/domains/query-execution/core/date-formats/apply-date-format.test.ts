...
import {
  ...
  WED,
  YEARS,
} from './apply-date-format.js';
import type { DateConfig } from './apply-date-format.js';
...
describe('when the fiscal year feature flag is disabled', () => {
  ...
  test.each([
     ...
     */
    {
      ...
      date: dec292009,
      format: 'short',
      expected: '29/12/2009, 06:28',
    },
    {
      locale: enUS,
      date: dec292009,
      format: 'short',
      expected: '12/29/2009, 6:28 am',
    },
    {
      locale: enUS,
      date: dec292009,
      format: 'fullDate',
      expected: 'Tuesday, December 29th, 2009',
    },
    {
      locale: enUS,
      date: dec292009,
      format: 'longDate',
      expected: 'December 29th, 2009',
    },
    {
      locale: enUS,
      date: dec292009,
    ...
    },
    {
      ...
      expected: 'Tuesday, December 29th, 2009 6:28:13 am',
    },
    {
      locale: enUS,
      date: dec292009,
