...
import {
  ...
  WidgetDto,
} from '../../../widgets/components/widget-by-id/types.js';
import { executePivotQuery, executeQuery } from '../../core/execute-query.js';
import { ExecuteQueryByWidgetIdParams } from '../../types.js';
import { useExecuteQueryByWidgetId, useParamsChanged } from './use-execute-query-by-widget-id.js';
