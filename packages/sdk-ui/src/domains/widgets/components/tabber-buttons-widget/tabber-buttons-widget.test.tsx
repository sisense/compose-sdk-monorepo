...
import { TabberButtonsWidget, tabsIntervalToCss, tabsSizeToCss } from './tabber-buttons-widget.js';
import type { TabberButtonsWidgetCustomOptions, TabberButtonsWidgetStyleOptions } from './types.js';
