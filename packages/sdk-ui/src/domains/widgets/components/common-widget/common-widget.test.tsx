...
// Mock child widgets:
vi.mock('@/domains/widgets/components/pivot-table-widget', () => ({
  PivotTableWidget: vi.fn(() => <div>Mocked PivotTableWidget</div>),
}));

vi.mock('@/domains/widgets/components/chart-widget', () => ({
  ChartWidget: vi.fn(() => <div>Mocked ChartWidget</div>),
}));

vi.mock('@/domains/widgets/components/text-widget', () => ({
  TextWidget: vi.fn(() => <div>Mocked TextWidget</div>),
}));

vi.mock('@/domains/widgets/components/custom-widget', () => ({
