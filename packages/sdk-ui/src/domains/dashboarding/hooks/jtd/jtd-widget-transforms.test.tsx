...
import * as jtdHandlers from './jtd-handlers.js';
import * as jtdMenu from './jtd-menu.js';
import { JtdWidgetTransformConfig } from './jtd-types.js';
import {
  addJtdIconToHeader,
...
} from './jtd-widget-transforms.js';

// Mock dependencies
vi.mock('@/domains/widgets/components/widget-by-id/utils', async (importOriginal) => {
