...
import { getDataOptionByLocation } from '@/utils/data-option-location';
...
import { useDrilldown } from '../hooks/use-drilldown.jsx';
import { useSyncedDrilldownPathsManager } from '../hooks/use-synced-drilldown-paths-manager.js';
import {
