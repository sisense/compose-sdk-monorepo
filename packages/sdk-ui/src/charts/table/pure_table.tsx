...
import { DataTableWrapper } from './data_table_wrapper';
import styles from './styles/table_chart.module.scss';
import { TableProps } from './types';
import { TableDesignOptions } from '../../chart-options-processor/translations/design_options';
import { orderBy } from '../../chart-data-processor/table_processor';
import { formatNumbers } from './helpers/format_numbers';
