import { seriesDataColorService } from '.';

const seriesYValues = [{ value: 1 }, { value: 1 }, { value: 2 }, { value: 3 }, { value: 5 }];

describe('seriesDataColorService', () => {
  describe('uniform colorOpts', () => {
    test('string', () => {
      expect(seriesDataColorService(seriesYValues, 'red')).toEqual([
        { value: 1, color: 'red' },
        { value: 1, color: 'red' },
        { value: 2, color: 'red' },
        { value: 3, color: 'red' },
    ...
    test('object', () => {
      expect(
        seriesDataColorService(seriesYValues, {
          type: 'uniform',
          color: 'red',
        }),
      ).toEqual([
