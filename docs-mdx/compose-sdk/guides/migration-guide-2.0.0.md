...
The minimum supported version of **React** ![React Logo](../img/logos/react-logo-small.png) is now v17.0.0.

## Minimum Angular Version

The minimum supported version of **Angular** ![Angular Logo](../img/logos/angular-logo-small.png) is now v17.
...
1. ### `DashboardWidget` Component
   ...
   ![React Logo](../img/logos/react-logo-small.png) **React**, ![Vue Logo](../img/logos/vue-logo-small.png) **Vue**
   ...
   ![Angular Logo](../img/logos/angular-logo-small.png) **Angular**
...
## Type Fixes
   ...
   ![React Logo](../img/logos/react-logo-small.png) ![Vue Logo](../img/logos/vue-logo-small.png) ![Angular Logo](../img/logos/angular-logo-small.png)  **All frameworks**:
   - The deprecated `CriteriaFilterType` type has been removed. Use the regular `Filter` type instead.

   ![Vue Logo](../img/logos/vue-logo-small.png) **Vue**:
