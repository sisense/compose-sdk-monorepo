...
> **Note**:
> This guide is for [Vue](../../getting-started/quickstart-vue.md) ![Vue Logo](../../img/logos/vue-logo-small.png). For other frameworks, see the [React](custom-widgets-react.md) ![React Logo](../../img/logos/react-logo-small.png) and [Angular](custom-widgets-angular.md) ![Angular Logo](../../img/logos/angular-logo-small.png) guides.
