...
> **Note**:
> This guide is for [Angular](../../getting-started/quickstart-angular.md) ![Angular Logo](../../img/logos/angular-logo-small.png). For other frameworks, see the [React](custom-widgets-react.md) ![React Logo](../../img/logos/react-logo-small.png) and [Vue](custom-widgets-vue.md) ![Vue Logo](../../img/logos/vue-logo-small.png) guides.
