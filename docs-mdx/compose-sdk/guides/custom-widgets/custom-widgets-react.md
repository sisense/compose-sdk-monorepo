...
> **Note**:
> This guide is for [React](../../getting-started/quickstart.md) ![React Logo](../../img/logos/react-logo-small.png). For other frameworks, see the [Angular](custom-widgets-angular.md) ![Angular Logo](../../img/logos/angular-logo-small.png) and [<img src="../../img/vue-logo.png" height="14px" /> Vue](custom-widgets-vue.md) guides.
