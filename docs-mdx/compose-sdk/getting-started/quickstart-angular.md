...
> **Note**:
> This guide is for [Angular](./quickstart-angular.md) ![Angular Logo](../img/logos/angular-logo-small.png). We also have a Quickstart Guide for [React](./quickstart.md)  ![React Logo](../img/logos/react-logo-small.png) and [Vue](./quickstart-vue.md) ![Vue Logo](../img/logos/vue-logo-small.png).
...
<img src='../img/quickstart-guides/angular-component-folders.png' height='200px' alt='Angular component folder structure'/>
...
![Line chart rendered by the Angular component](../img/quickstart-guides/angular-quickstart-chart-example.png)
