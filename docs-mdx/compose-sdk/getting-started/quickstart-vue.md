...
> **Note**:
> This guide is for [Vue](./quickstart-vue.md) ![Vue Logo](../img/logos/vue-logo-small.png). We also have a Quickstart Guide for [React](./quickstart.md)  ![React Logo](../img/logos/react-logo-small.png) and [Angular](./quickstart-angular.md)  ![Angular Logo](../img/logos/angular-logo-small.png).
...
<div style={{display: 'flex', marginRight: '10px'}}>
  <div style={{flex: 1, overflowX: 'auto', maxWidth: 'calc(50% - 5px)'}}>
...
```
  ...
  <div style={{flex: 1, marginLeft: '10px', overflowX: 'auto', maxWidth: 'calc(50% - 5px)'}}>
...
<img src="../img/quickstart-guides/vue-create-new-project.png" height="200px" alt="Vue project creation prompt"/>
...
![Line chart rendered by the Vue component](../img/quickstart-guides/vue-quickstart-chart-example.png)
