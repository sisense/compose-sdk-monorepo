// @observablehq/runtime v5.6.1 Copyright 2023 Observable, Inc.
function e(e, t, n) {
  n = n || {};
...
function* R(e) {
  ...
  for (const n = e.length; r < n; ++r)
    r in e && (r > t + 1 && (yield F(r - t - 1)), yield ae(p(e, r), !0), (t = r));
  r > t + 1 && (yield F(r - t - 1));
...
function F(e) {
  const t = document.createElement('span');
  return (
    (t.className = 'observablehq--empty'), (t.textContent = 1 === e ? 'empty' : `empty × ${e}`), t
  );
}
function B(e, t, n) {
...
function W(e, t) {
  ...
  return `${
    ((i = e.getUTCFullYear()), i < 0 ? `-${H(-i, 6)}` : i > 9999 ? `+${H(i, 6)}` : H(i, 4))
  }-${H(e.getUTCMonth() + 1, 2)}-${H(e.getUTCDate(), 2)}${
    n || r || o || a
      ? `T${H(n, 2)}:${H(r, 2)}${o || a ? `:${H(o, 2)}${a ? `.${H(a, 3)}` : ''}` : ''}Z`
      : ''
  }`;
  var i;
}
...
class Inspector {
  ...
  rejected(t, n) {
    const { _node: o } = this;
    for (
      o.classList.remove('observablehq--running'), o.classList.add('observablehq--error');
      o.lastChild;
...
const Ne = Ce('d3', '7.8.4', 'dist/d3.min.js'),
  xe = Ce('@observablehq/inputs', '0.10.4', 'dist/inputs.min.js'),
  Te = Ce('@observablehq/plot', '0.6.6', 'dist/plot.umd.min.js'),
...
function nt(e = 'https://cdn.jsdelivr.net/npm/', t = ['unpkg', 'jsdelivr', 'browser', 'main']) {
  ...
  return async function (r, o) {
    ...
    if (
      (a.path && !et.test(a.path) && (a.path += '.js'), a.path && a.version && Qe.test(a.version))
    )
    ...
    return `${e}${i.name}@${i.version}/${
      ...
      (function (e) {
        for (const n of t) {
          let t = e[n];
          if ('string' == typeof t)
            return t.startsWith('./') && (t = t.slice(2)), et.test(t) ? t : `${t}.js`;
        }
      })(i) ||
      'index.js'
    }`;
...
function ot(e) {
  ...
  function a(e) {
    return arguments.length > 1 ? Promise.all(Ze.call(arguments, n)).then(at) : n(e);
  }
  return (
    (a.alias = function (t) {
      return ot((n, r) => (n in t && ((r = null), 'string' != typeof (n = t[n])) ? n : e(n, r)));
    }),
    (a.resolve = e),
    a
  );
...
function at(e) {
  ...
  for (const n of e)
    for (const e in n)
      Ke.call(n, e) &&
        (null == n[e] ? Object.defineProperty(t, e, { get: it(n, e) }) : (t[e] = n[e]));
  return t;
}
function it(e, t) {
  return () => e[t];
      ...
      Je.call(t, st)
        ? (e) => {
            const r = {},
              o = { exports: r };
            return Promise.all(
              Ze.call(t, (t) => ('exports' === (t += '') ? r : 'module' === t ? o : e(t))),
            ).then((e) => (n.apply(null, e), o.exports));
          }
        : (e) =>
            Promise.all(Ze.call(t, e)).then((e) => ('function' == typeof n ? n.apply(null, e) : n)),
    );
}
ct.amd = {};
...
function yt(e, t = wt) {
  ...
  } else for (const o of e) (r ? t(o, n) > 0 : 0 === t(o, o)) && ((n = o), (r = !0));
  return n;
}
function vt(e) {
...
function gt(e) {
  return { name: e.name, type: Et(e.type), nullable: e.nullable, databaseType: String(e.type) };
}
function Et(e) {
  switch (e.typeId) {
    case 2:
...
class DuckDBClient {
  ...
  async queryStream(e, t) {
    ...
    return {
      schema: ((a = o.value), a.schema.fields.map(gt)),
      async *readRows() {
        try {
      ...
      await Promise.all(
        Object.entries(e).map(async ([e, t]) => {
          if (t instanceof FileAttachment) await Nt(n, e, t);
            ...
            const { data: r, ...o } = t;
            _t(r) ? await xt(n, e, r, o) : await Tt(n, e, r, o);
          } else {
  ...
  async (e, t, n, r) => {
      ...
      (o = e) &&
        ('function' == typeof o.sql ||
          ('function' == typeof o.queryTag &&
            ('function' == typeof o.query || 'function' == typeof o.queryStream))) &&
          ...
          if ('mssql' === t.dialect || 'oracle' === t.dialect) {
            if (null !== s.to || null !== s.from) {
              if (!i.length) {
                ...
                zt('\nORDER BY ', l), Wt({ column: r.columns[0], direction: 'ASC' }, l, n);
              }
    ...
    if (jt(e))
      return (function (e, t) {
        const n = e;
        let { columns: r } = e,
          { schema: o, inferred: a } = (function (e) {
            const { columns: t } = e;
            let { schema: n } = e;
            if (!$t(n)) return (n = dn(e, St(t) ? t : void 0)), { schema: n, inferred: !0 };
            return { schema: n, inferred: !1 };
          })(e);
        const i = new Map(o.map(({ name: e, type: t }) => [e, t]));
        if (t.types) {
          for (const { name: e, type: r } of t.types) {
            i.set(e, r), o === n.schema && (o = o.slice());
            const t = o.findIndex((t) => t.name === e);
            t > -1 && (o[t] = { ...o[t], type: r });
          }
          e = e.map((e) => un(e, i, o));
        } else a && (e = e.map((e) => un(e, i, o)));
...
const Rt = Pt(async (e, t) => {
    ...
    return _t(e) || vt(e) ? Dt(e, t) : jt(e) && Ot(e) ? Array.from(e, (e) => ({ value: e })) : e;
  }),
  Ut = Pt(async (e, t) => {
    if (e instanceof FileAttachment) {
      switch (e.mimeType) {
...
const fn = ['boolean', 'integer', 'number', 'date', 'bigint', 'array', 'object', 'buffer'];
function dn(
  e,
  t = (function (e) {
    const t = new Set();
    for (const n of e)
      if (n) for (const e in n) Object.prototype.hasOwnProperty.call(n, e) && t.add(e);
    return Array.from(t);
  })(e),
) {
  const n = [],
  ...
  for (const e of t) {
    ...
    const o = Math.max(1, 0.9 * t.defined),
      a = yt(fn, (e) => (t[e] >= o ? t[e] : NaN)) ?? (t.string >= o ? 'string' : 'other');
...
class Workbook {
  ...
  sheet(e, t) {
    const n =
      'number' == typeof e ? this.sheetNames[e] : this.sheetNames.includes((e += '')) ? e : null;
    ...
    return (function (e, { range: t, headers: n } = {}) {
      let [[r, o], [a, i]] = (function (e = ':', { columnCount: t, rowCount: n }) {
        ...
        const [[r = 0, o = 0], [a = t - 1, i = n - 1]] = e.split(':').map(bn);
        return [
          [r, o],
          [a, i],
        ];
      ...
      let c = new Set(['#']);
      for (let e = r; e <= a; e++) {
        const t = s ? pn(s.findCell(e + 1)) : null;
        let n = (t && t + '') || hn(e);
        for (; c.has(n); ) n += '_';
        c.add(n);
      }
...
function pn(e) {
  ...
  if (t && 'object' == typeof t && !(t instanceof Date)) {
    ...
    if (t.richText) return mn(t);
    if (t.text) {
      let { text: e } = t;
      return (
        e.richText && (e = mn(e)), t.hyperlink && t.hyperlink !== e ? `${t.hyperlink} ${e}` : e
      );
    }
    return t;
  }
...
async function yn(e, t, { array: n = !1, typed: r = !1 } = {}) {
...
class vn {
  ...
  async blob() {
    return (await wn(this)).blob();
  }
  async arrayBuffer() {
    return (await wn(this)).arrayBuffer();
  }
  async text() {
    return (await wn(this)).text();
  }
  async json() {
    return (await wn(this)).json();
  }
  async stream() {
    return (await wn(this)).body;
  }
  async csv(e) {
    return yn(this, ',', e);
  }
  ...
  async arrow({ version: e = 4 } = {}) {
    switch (e) {
      case 4: {
        const [e, t] = await Promise.all([ft(Re.resolve()), wn(this)]);
        return e.Table.from(t);
      }
      case 9: {
        const [e, t] = await Promise.all([import(`${lt}${Ue.resolve()}`), wn(this)]);
        return e.tableFromIPC(t);
      }
      case 11: {
        const [e, t] = await Promise.all([import(`${lt}${De.resolve()}`), wn(this)]);
        return e.tableFromIPC(t);
      }
      default:
  ...
  async sqlite() {
    return SQLiteDatabaseClient.open(wn(this));
  }
  async zip() {
...
class FileAttachment extends vn {
  constructor(e, t, n) {
...
class ZipArchiveEntry extends vn {
  constructor(e) {
    super(e.name),
      Object.defineProperty(this, '_', { value: e }),
...
var xn = Object.freeze({
  ...
  element: function (e, t) {
    ...
    var a = gn.hasOwnProperty(r) ? document.createElementNS(gn[r], e) : document.createElement(e);
    if (t)
      for (var i in t)
        (o = (r = i).indexOf(':')),
          (n = t[i]),
          o >= 0 && 'xmlns' !== (r = i.slice(0, o)) && (i = i.slice(o + 1)),
          gn.hasOwnProperty(r) ? a.setAttributeNS(gn[r], i, n) : a.setAttribute(i, n);
    return a;
  },
  input: function (e) {
...
function On(e, t) {
  return function (n) {
    ...
    if (((p = e(f)), ++m > 0)) {
      for (
        a = new Array(m), i = document.createTreeWalker(p, NodeFilter.SHOW_COMMENT, null, !1);
        i.nextNode();
...
var Rn = Object.freeze({
  ...
  tick: function (e, t) {
    return Pn(Math.ceil((Date.now() + 1) / e) * e, t);
  },
  when: Pn,
});
function Un(e, t) {
  ...
  Object.defineProperties(
    function (e) {
      ...
      Object.defineProperties(
        ...
        ((n = {
                              ...
                              : e(je.resolve('async-languages/index.js'))
                                  .then((r) => {
                                    if (r.has(n.className))
                                      return e(
                                        je.resolve('async-languages/' + r.get(n.className)),
                                      ).then((e) => {
          ...
          tex: () =>
            (function (e) {
              return Promise.all([
                e($e.resolve()),
                e.resolve($e.resolve('dist/katex.min.css')).then(Bn),
              ]).then(function (e) {
                var t = e[0],
                  n = r();
                function r(e) {
                  return function () {
                    ...
                    return t.render(Fn.apply(String, arguments), n, e), n.removeChild(n.firstChild);
                  };
                }
          ...
          Inputs: () => t(xe.resolve()).then((e) => ({ ...e, file: e.fileOf(vn) })),
          L: () =>
            (async function (e) {
            ...
            (async function (e) {
              ...
              return (
                ...
                function () {
                  ...
                  return (
                    (e.innerHTML = t.render(Cn().id, String.raw.apply(String, arguments))),
        ...
        Object.fromEntries(Object.entries(n).map(Wn))),
      );
    },
    {
...
const Gn = Array.prototype.map;
function Yn() {}
const Zn = Symbol('no-observer');
function Variable(e, t, n) {
  var r;
  n || (n = Zn),
    Object.defineProperties(this, {
      _observer: { value: n, writable: !0 },
      _definition: { value: Xn, writable: !0 },
      ...
      _invalidate: { value: Yn, writable: !0 },
      _module: { value: t },
      _name: { value: null, writable: !0 },
      _outputs: { value: new Set(), writable: !0 },
      _promise: { value: Promise.resolve(void 0), writable: !0 },
      _reachable: { value: n !== Zn, writable: !0 },
      _rejector: {
        value:
          ((r = this),
          (e) => {
            if (e === Qn) throw e;
            if (e === Xn) throw new RuntimeError(`${r._name} is not defined`, r._name);
...
function tr(e, t, n) {
  ...
  if (
    (this._inputs.forEach(Kn, this),
    t.forEach(Jn, this),
    (this._inputs = t),
    (this._definition = n),
    (this._value = void 0),
    n === Yn ? o._variables.delete(this) : o._variables.add(this),
    ...
    e &&
      ((a = r.get(e))
        ? 3 === a._type
          ? ((this._definition = er(e)), (this._duplicate = n), a._duplicates.add(this))
          : 2 === a._type
          ...
          : ((a._duplicate = a._definition),
            ...
            (t._name = e),
            (t._definition = this._definition = a._definition = er(e)),
...
Object.defineProperties(Variable.prototype, {
  ...
  define: {
    value: function (e, t, n) {
      ...
      return tr.call(
        ...
        null == t ? [] : Gn.call(t, this._module._resolve, this._module),
  ...
  import: {
    value: function (e, t, n) {
      ...
      return tr.call(this, String(t), [n._resolve(String(e))], Vn);
    },
    writable: !0,
    configurable: !0,
  },
});
const nr = Symbol('variable'),
  rr = Symbol('invalidation'),
  or = Symbol('visibility');
function Module(e, t = []) {
  Object.defineProperties(this, {
    _runtime: { value: e },
    _scope: { value: new Map() },
    _builtins: {
      value: new Map([['@variable', nr], ['invalidation', rr], ['visibility', or], ...t]),
    },
...
Object.defineProperties(Module.prototype, {
    ...
    value: function (e) {
      ...
      if (!n)
        if (((n = new Variable(2, this)), this._builtins.has(e)))
          n.define(e, Hn(this._builtins.get(e)));
          ...
          void 0 === t ? this._scope.set((n._name = e), n) : n.define(e, Hn(t));
        }
      return n;
    },
    writable: !0,
      ...
      for (const [e, t] of o)
        for (const [r, o] of t._scope) {
          ...
          if (!t || 2 === t._type)
            ...
            } else e.define(r, o._inputs.map(ir), o._definition);
        }
      return i;
    },
    writable: !0,
  ...
  value: {
    value: async function (e) {
      ...
      if (!t) throw new RuntimeError(`${e} is not defined`);
      if (t._observer !== Zn) return ar(this._runtime, t);
      t = this.variable(!0).define([e], Vn);
      try {
        return await ar(this._runtime, t);
      } finally {
        t.delete();
      }
    },
...
const sr =
  'function' == typeof requestAnimationFrame
    ...
    ? setImmediate
    : (e) => setTimeout(e, 0);
function Runtime(e = new Library(), t = br) {
  const n = this.module();
  if (
    (Object.defineProperties(this, {
...
function mr(e) {
  e._invalidate(), (e._invalidate = Yn), e._pending();
  const t = e._value,
    n = ++e._version;
  let r = null;
  const o = (e._promise = (
    e._inputs.length
      ? Promise.all(e._inputs.map(fr)).then(function (o) {
          if (e._version !== n) throw Qn;
    ...
    if (
      ...
      return (
        ...
        (function (e, t, n) {
          ...
          function i() {
            const n = a((a) => {
              if (e._version !== t) throw Qn;
              return (o = a), s(a, n).then(() => r._precompute(i)), e._fulfilled(a), a;
            });
            n.catch((r) => {
              r !== Qn && e._version === t && (s(void 0, n), e._rejected(r));
            });
          }
          function s(t, n) {
            return (
  ...
  o.then(
    ...
    (t) => {
      t !== Qn && ((e._value = void 0), e._rejected(t));
    },
  );
}
function hr(e, t) {
  e._invalidate(),
    ...
    ++e._version,
    (e._indegree = NaN),
    (e._promise = Promise.reject(t)).catch(Yn),
    (e._value = void 0),
    e._rejected(t);
}
function br(e) {
...
Object.defineProperties(Runtime.prototype, {
  ...
  _computeSoon: {
    value: function () {
      return new Promise(sr).then(() => (this._disposed ? void 0 : this._computeNow()));
    },
    writable: !0,
    configurable: !0,
  },
    ...
    value: async function () {
      ...
      do {
        for (
          ...
          mr(t), t._outputs.forEach(o), e.delete(t);
        e.forEach(function (t) {
          cr(t) &&
            (hr(t, new RuntimeError('circular definition')), t._outputs.forEach(ur), e.delete(t));
        });
      } while (e.size);
      function o(e) {
        0 == --e._indegree && n.push(e);
